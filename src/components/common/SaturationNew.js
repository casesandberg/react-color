...
import * as saturationNew from '../../helpers/saturationNew'

export class SaturationNew extends (PureComponent || Component) {
  componentWillUnmount() {
    this.unbindEventListeners()
  }

  handleChange = (e) => {
    const change = saturationNew.calculateChange(e, this.props.direction, this.props.hsl, this.container)
  ...
  render() {
    ...
    return (
      <div style={ styles.hue }>
        <div
          className={ `saturationNew-${ direction }` }
