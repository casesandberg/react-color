    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          'div',
          { is: 'saturation' },
          React.createElement(Saturation, _extends({ is: 'Saturation' }, this.props, { onChange: this.handleChange }))
        ),
        React.createElement(
          'div',
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              { is: 'hue' },
              React.createElement(Hue, _extends({ is: 'Hue' }, this.props, { onChange: this.handleChange }))
            ),
            React.createElement(
              'div',
              { is: 'alpha' },
              React.createElement(Alpha, _extends({ is: 'Alpha' }, this.props, { onChange: this.handleChange }))
            )
          ),
          React.createElement(
            'div',
            { is: 'color' },
            React.createElement('div', { is: 'activeColor' }),
