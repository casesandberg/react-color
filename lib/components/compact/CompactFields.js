  ...
  _createClass(CompactColor, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(EditableInput, { is: 'RGB', label: 'r', value: this.props.rgb.r, onChange: this.handleChange }),
        React.createElement(EditableInput, { is: 'RGB', label: 'g', value: this.props.rgb.g, onChange: this.handleChange }),
        React.createElement(EditableInput, { is: 'RGB', label: 'b', value: this.props.rgb.b, onChange: this.handleChange })
      );
    }
  }]);
