...
var Sketch = exports.Sketch = function (_React$Component) {
  ...
  function Sketch() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Sketch.__proto__ || Object.getPrototypeOf(Sketch)).call.apply(_ref, [this].concat(args))), _this), _this.shouldComponentUpdate = _reactAddonsShallowCompare2.default.bind(_this, _this, arguments[0], arguments[1]), _this.handleChange = function (data) {
