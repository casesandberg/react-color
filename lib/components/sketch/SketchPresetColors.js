...
var SketchPresetColors = exports.SketchPresetColors = function (_React$Component) {
  ...
  function SketchPresetColors() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SketchPresetColors.__proto__ || Object.getPrototypeOf(SketchPresetColors)).call.apply(_ref, [this].concat(args))), _this), _this.shouldComponentUpdate = _reactAddonsShallowCompare2.default.bind(_this, _this, arguments[0], arguments[1]), _this.handleClick = function (hex) {
      _this.props.onClick({
        hex: hex,
        source: 'hex'
      });
