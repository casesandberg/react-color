...
var Swatches = exports.Swatches = function (_React$Component) {
  ...
  function Swatches() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Swatches.__proto__ || Object.getPrototypeOf(Swatches)).call.apply(_ref, [this].concat(args))), _this), _this.shouldComponentUpdate = _reactAddonsShallowCompare2.default.bind(_this, _this, arguments[0], arguments[1]), _this.handleChange = function (data) {
