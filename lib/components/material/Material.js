...
var Material = exports.Material = function (_React$Component) {
  ...
  function Material() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Material.__proto__ || Object.getPrototypeOf(Material)).call.apply(_ref, [this].concat(args))), _this), _this.shouldComponentUpdate = _reactAddonsShallowCompare2.default.bind(_this, _this, arguments[0], arguments[1]), _this.handleChange = function (data) {
      if (data.hex) {
