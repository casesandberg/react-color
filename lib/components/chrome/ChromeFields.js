    ...
    value: function render() {
      ...
      if (this.state.view === 'hex') {
        fields = React.createElement(
          ...
          React.createElement(
            'div',
            { is: 'field' },
            React.createElement(EditableInput, { is: 'Input', label: 'hex', value: '#' + this.props.hex, onChange: this.handleChange })
          )
        );
      } else if (this.state.view === 'rgb') {
        fields = React.createElement(
          ...
          React.createElement(
            'div',
            { is: 'field' },
            React.createElement(EditableInput, { is: 'Input', label: 'r', value: this.props.rgb.r, onChange: this.handleChange })
          ),
          React.createElement(
            'div',
            { is: 'field' },
            React.createElement(EditableInput, { is: 'Input', label: 'g', value: this.props.rgb.g, onChange: this.handleChange })
          ),
          React.createElement(
            'div',
            { is: 'field' },
            React.createElement(EditableInput, { is: 'Input', label: 'b', value: this.props.rgb.b, onChange: this.handleChange })
          ),
          React.createElement(
            'div',
            { is: 'field' },
            React.createElement(EditableInput, { is: 'Input', label: 'a', value: this.props.rgb.a, arrowOffset: .01, onChange: this.handleChange })
          )
        );
      } else if (this.state.view === 'hsl') {
        fields = React.createElement(
          ...
          React.createElement(
            'div',
            { is: 'field' },
            React.createElement(EditableInput, { is: 'Input', label: 'h', value: Math.round(this.props.hsl.h), onChange: this.handleChange })
          ),
          React.createElement(
            'div',
            { is: 'field' },
            React.createElement(EditableInput, { is: 'Input', label: 's', value: Math.round(this.props.hsl.s * 100) + '%', onChange: this.handleChange })
          ),
          React.createElement(
            'div',
            { is: 'field' },
            React.createElement(EditableInput, { is: 'Input', label: 'l', value: Math.round(this.props.hsl.l * 100) + '%', onChange: this.handleChange })
          ),
          React.createElement(
            'div',
            { is: 'field' },
            React.createElement(EditableInput, { is: 'Input', label: 'a', value: this.props.hsl.a, arrowOffset: .01, onChange: this.handleChange })
          )
        );
      }
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { is: 'icon', onClick: this.toggleViews },
            React.createElement(
              'svg',
          ...
          React.createElement('div', { is: 'iconHighlight', ref: 'iconHighlight' })
        )
      );
    }
  }]);
