...
var SliderPointer = exports.SliderPointer = function (_React$Component) {
  ...
  function SliderPointer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SliderPointer.__proto__ || Object.getPrototypeOf(SliderPointer)).call.apply(_ref, [this].concat(args))), _this), _this.shouldComponentUpdate = _reactAddonsShallowCompare2.default.bind(_this, _this, arguments[0], arguments[1]), _temp), _possibleConstructorReturn(_this, _ret);
  }
