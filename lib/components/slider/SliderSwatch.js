...
var SliderSwatch = exports.SliderSwatch = function (_React$Component) {
  ...
  function SliderSwatch() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SliderSwatch.__proto__ || Object.getPrototypeOf(SliderSwatch)).call.apply(_ref, [this].concat(args))), _this), _this.shouldComponentUpdate = _reactAddonsShallowCompare2.default.bind(_this, _this, arguments[0], arguments[1]), _this.handleClick = function () {
      _this.props.onClick({
        h: _this.props.hsl.h,
        s: 0.5,
