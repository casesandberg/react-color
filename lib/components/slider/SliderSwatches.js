...
var SliderSwatches = exports.SliderSwatches = function (_React$Component) {
  ...
  function SliderSwatches() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SliderSwatches.__proto__ || Object.getPrototypeOf(SliderSwatches)).call.apply(_ref, [this].concat(args))), _this), _this.shouldComponentUpdate = _reactAddonsShallowCompare2.default.bind(_this, _this, arguments[0], arguments[1]), _this.handleClick = function (data) {
