...
import { React, TestUtils, expect, chai } from '../config'
...
describe('CompactColor', () => {
  it('should call onClick when a color is clicked on and pass back color', () => {
    ...
    const CompactColor = TestUtils.renderIntoDocument(
      <CompactColorComponent onClick={ onClick } color="#333" />
    )
    const color = CompactColor.refs.color
